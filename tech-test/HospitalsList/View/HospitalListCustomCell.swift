...
class HospitalListCustomCell: UITableViewCell {
    ...
    func setAccessibilityIdentifiers() {
        hospitalNameLabel.accessibilityIdentifier = "hospitalNameLabel"
        hospitalType.accessibilityIdentifier = "hospitalTypeLabel"
        hospitalId.accessibilityIdentifier = "hospitalId"
        hospitalPhone.accessibilityIdentifier = "hospitalPhoneLabel"
        hospitalEmail.accessibilityIdentifier = "hospitalEmailLabel"
        hospitalAddress.accessibilityIdentifier = "hospitalAddressLabel"
    }
    ...
    func configure(model: HospitalModel) {
        ...
        if let email = model.email {
            if !email.isEmpty {
                hospitalEmail.text = "Email: \(email)"
            }
        }
